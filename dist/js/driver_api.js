...
// 加群 group/joinGroup
export const postJoinGroup = (options) => _apiPOST(`${API_ROOT}/group/joinGroup`, options)
...
// 钱包信息 driver/money
export const getMoneyDetails = (options) => _apiPOST(`${API_ROOT}/driver/moneylv1`, options)

export const postLike = (options) => _apiPOST(`${API_ROOT}/feed/travelLike`, options)

export const travelUnlike = (options) => _apiPOST(`${API_ROOT}/feed/travelUnlike`, options)
...
export const deleteTravel = (options) => _apiPOST(`${API_ROOT}/travel/cancelv1`, options)

// 删除已完成行程 /travel/history/delete
export const deleteOverTravel = (options) => _apiPOST(`${API_ROOT}/travel/history/delete`, options)

// /travel/publishPrice new发布行程价格
export const postTravelPrice = (options) => _apiPOST(`${API_ROOT}/travel/publishPrice`, options)

// 查看我发布的行程 /feed/eachFeedList
export const getMineTravelList = (options) => _apiPOST(`${API_ROOT}/feed/eachFeedList`, options)

// 查看我的所有行程 /travel/myTravel1
export const getMineAllTravel = (options) => _apiPOST(`${API_ROOT}/travel/myTravel1`, options)
...
export const auditOwnerList = (options) => _apiPOST(`${API_ROOT}/driver/auth/page`, options)

export const auditInfo = (options) => _apiPOST(`${API_ROOT}/driver/auth/checkInfo`, options)

export const auditOwner = (options) => _apiPOST(`${API_ROOT}/driver/auth/changeStatus`, options)

export const driverGrabAsingle = (options) => _apiPOST(`${API_ROOT}/travel/driverSeckill`, options)

// /group/myJoinedGroups
export const myJoinedGroups = (options) => _apiPOST(`${API_ROOT}/group/myJoinedGroups`, options)

// /group/hotGroups
export const hotGroups = (options) => _apiPOST(`${API_ROOT}/group/hotGroups`, options)

// /group/groupDetail
export const groupDetail = (options) => _apiPOST(`${API_ROOT}/group/groupDetail`, options)

// /travel/searchTravel
export const searchTravel = (options) => _apiPOST(`${API_ROOT}/travel/searchTravel`, options)

// /group/groupMembers
export const groupMembers = (options) => _apiPOST(`${API_ROOT}/group/groupMembers`, options)

// attention/pullAttention 
export const pullAttention = (options) => _apiPOST(`${API_ROOT}/attention/pullAttention`, options)

// /group/leaveGroup
export const leaveGroup = (options) => _apiPOST(`${API_ROOT}/group/leaveGroup`, options)

// /group/crossCityGroupDetail
export const crossCityGroupDetail = (options) => _apiPOST(`${API_ROOT}/group/crossCityGroupDetail`, options)
